        ...
        <div className='container mx-auto px-4 relative z-10'>
          <div className='max-w-2xl space-y-6'>
            ...
            <p className='text-xl text-white/90'>
              Connect with local communities to share surplus food and make a real difference in
              people&apos;s lives.
            </p>
            ...
            {[
              ...
              <div key={i} className='relative'>
                <div className='bg-card rounded-lg p-8 h-full border'>
                  <div className='mb-4 p-3 bg-primary rounded-full w-fit'>{step.icon}</div>
                  <h3 className='text-xl font-semibold mb-2'>{step.title}</h3>
                  <p className='text-muted-foreground'>{step.desc}</p>
                </div>
                {i < 2 && (
                  <ArrowRight className='hidden md:block absolute top-1/2 -right-8 bg-white text-black rounded-full w-6 h-6 text-primary' />
                )}
              </div>
            ))}
          </div>
